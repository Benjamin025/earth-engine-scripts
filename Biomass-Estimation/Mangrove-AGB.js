...
// 1. Create a cloud mask composite using sentinel-2 over time
// 2. Classify mangrove cover using spectral indices
// 3. Modelling biomass with sentinel-2 and GEDI biomass
// 4. Calculate biomass total and mangrove cover area
// 5. Multi temporal analysis of mangrove area and its biomass
// The analysis is done in Sembilang National Park, South Sumatera, Indonesia
...
print(
  ...
  '3. Modelling biomass with sentinel-2 and GEDI biomass',
  '4. Calculate biomass total and mangrove cover area',
  'The analysis is done in Taman Nasional Sembilang, South Sumatera'
);
